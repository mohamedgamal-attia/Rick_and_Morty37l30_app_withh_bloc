      ...
      return [
        Padding(
          ...
          child: IconButton(
            ...
            icon: Icon(Icons.clear, color: MyColors.myGrey,size: 20.w,),
          ),
        ),
      ];
    } else {
        ...
        child: Center(
          child: AppBar(
            ...
            leading: _isSearching
                ? IconButton(onPressed: (){Navigator.pop(context);}, icon: Icon(Icons.arrow_back,size: 25.w,color: Colors.black,))
                : Container(),
